...
CREATE TABLE PRODUCTO(
	...
	CONSTRAINT FK_FAMILIA FOREIGN KEY (CODFAMILIA) REFERENCES FAMILIA(CODFAMILIA)ON DELETE CASCADE,
	CONSTRAINT FK_GENERO FOREIGN KEY (CODGENERO) REFERENCES GENERO(CODGENERO)ON DELETE CASCADE,
