...
CREATE TABLE DEPARTAMENTO(
	...
	CONSTRAINT FK_SEDE FOREIGN KEY(COD_SEDE) REFERENCES SEDE(CODSEDE)
);
CREATE TABLE PROGRAMADOR(
    ...
    CONSTRAINT FK_DEPARTAMENTO FOREIGN KEY(COD_DEP_PROGRAMADOR, COD_SEDE_PROGRAMADOR) REFERENCES DEPARTAMENTO(CODDEP, COD_SEDE)
);
CREATE TABLE EQUIPO(
	...
	CONSTRAINT FK_PROGRAMADOR FOREIGN KEY(COD_SEDE_PROGRAMADOR_EQUIPO, COD_DEP_PROGRAMADOR_EQUIPO,SECUENCIA) REFERENCES PROGRAMADOR(COD_SEDE_PROGRAMADOR, COD_DEP_PROGRAMADOR, SECUENCIA)
);
CREATE TABLE EQUIPOPROG(
	...
	CONSTRAINT FK_PROGRAMADOR_EQUIPO FOREIGN KEY(SECUENCIA_EQUIPOPROG) REFERENCES PROGRAMADOR(SECUENCIA),
	CONSTRAINT FK_EQUIPO_PROGRAMADOR FOREIGN KEY(CODEQUIPO_EQUIPOPROG) REFERENCES EQUIPO(CODEQUIPO)
);
